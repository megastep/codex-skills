...
- Use `$feature-forge` as the command-style label when providing examples.
- For cross-domain features, use Codex multi-agent delegation (`spawn_agent` + `wait`) for parallel discovery and synthesize into one spec.
