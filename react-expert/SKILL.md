...
- Use `$react-expert` as the command-style label when providing examples.
- For broad app refactors or audits, use Codex multi-agent delegation (`spawn_agent` + `wait`) and consolidate findings before delivery.
