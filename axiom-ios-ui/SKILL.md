...
**View not updating** → `$axiom-swiftui-debugging`
**Navigation issues** → `$axiom-swiftui-nav`
**Performance/lag** → `$axiom-swiftui-performance`
**Layout problems** → `$axiom-swiftui-layout`
**Stacks/grids/outlines** → `$axiom-swiftui-containers-ref`
**Animation issues** → `$axiom-swiftui-animation-ref`
**Gesture conflicts** → `$axiom-swiftui-gestures`
**Drag/drop, copy/paste, sharing** → `$axiom-transferable-ref`
**Architecture/testability** → `$axiom-swiftui-architecture`
**App-level composition** → `$axiom-app-composition`
**Search implementation** → `$axiom-swiftui-search-ref`
**iOS 26 features** → `$axiom-swiftui-26-ref`
**UIKit bridging (Representable, HostingController)** → `$axiom-uikit-bridging`

### UIKit Issues

**Auto Layout conflicts** → `$axiom-auto-layout-debugging`
**Animation timing issues** → `$axiom-uikit-animation-debugging`
**SwiftUI embedding (HostingController, HostingConfiguration)** → `$axiom-uikit-bridging`

### Design & Guidelines

**Liquid Glass adoption** → `$axiom-liquid-glass`
**SF Symbols (effects, rendering, custom)** → `$axiom-sf-symbols`
**Design decisions** → `$axiom-hig`
**Typography** → `$axiom-typography-ref`
**TextKit/rich text** → `$axiom-textkit-ref`

### tvOS

**Focus Engine, remote input, TVUIKit, text input** → `$axiom-tvos`

### Accessibility

**VoiceOver, Dynamic Type** → `$axiom-accessibility-diag`

### Testing

**UI test flakiness** → `$axiom-ui-testing`
