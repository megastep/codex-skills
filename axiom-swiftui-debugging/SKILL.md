...
3. Nuke derived data: `Open Xcode Settings -> Locations -> Derived Data, then remove the specific project folder manually`
4. Rebuild: `Cmd+B`
...
3. Nuke derived data: `Open Xcode Settings -> Locations -> Derived Data, then remove the specific project folder manually` (30 seconds)
...
// Fix 3: Nuke cache
// Terminal: Open Xcode Settings -> Locations -> Derived Data, then remove the specific project folder manually
```
