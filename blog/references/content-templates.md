...
quality scoring checklist (see `quality-scoring.md`). Templates
...
Templates are editable markdown files in `../templates/`.
...
1. Copy an existing template as a starting point:
   ```bash
   cp ../templates/how-to-guide.md \
      ../templates/my-custom-type.md
   ```
...
| Schema | FAQPage schema must be generated (see `content-rules.md`) |
