...
For CarPlay-specific integration patterns, invoke `$axiom-now-playing-carplay`.
...
For MusicKit-specific integration patterns and hybrid app examples, invoke `$axiom-now-playing-musickit`.
