...
**Strategy decisions** → `$axiom-metal-migration`
...
**API reference & conversion** → `$axiom-metal-migration-ref`
...
**Diagnostics** → `$axiom-metal-migration-diag`
...
**Frame rate & render loops** → `$axiom-display-performance`
